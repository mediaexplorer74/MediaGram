...
namespace TeleSharp.TL
{
  ...
  public class TLConfig : TLObject
  {
    ...
    {
      this.Flags = 0;
      this.Flags = this.PhonecallsEnabled ? this.Flags | 2 : this.Flags & -3;
    ...
    public override void DeserializeBody(BinaryReader br)
    {
      ...
      this.DcOptions = ObjectUtils.DeserializeVector<TLDcOption>(br);
      ...
      this.DisabledFeatures = ObjectUtils.DeserializeVector<TLDisabledFeature>(br);
    }
    ...
    public override void SerializeBody(BinaryWriter bw)
    {
      ...
      ObjectUtils.SerializeObject((object) this.DisabledFeatures, bw);
    }
  }
}
