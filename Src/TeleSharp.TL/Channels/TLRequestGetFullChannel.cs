...
// Type: TeleSharp.TL.Channels.TLRequestGetFullChannel
...
namespace TeleSharp.TL.Channels
{
  ...
  public class TLRequestGetFullChannel : TLMethod
  {
    ...
    public TeleSharp.TL.Messages.TLChatFull Response { get; set; }
    ...
    {
      this.Response = (TeleSharp.TL.Messages.TLChatFull) ObjectUtils.DeserializeObject(br);
    }
  }
}
